...
// Check if user has PIN set (from Django User Model Property)
const isChanging = computed(() => authStore.profile?.is_pin_set || false)

// --- UPDATED KEYS GENERATION ---
const keys = [
  // Loop 1 to 9
...
// Determine which array receives the input
